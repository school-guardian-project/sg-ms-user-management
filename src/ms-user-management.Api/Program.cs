...
builder.Services.AddScoped<CreateParentService>();
builder.Services.AddScoped<UpdateParentService>();
builder.Services.AddScoped<DeleteParentService>();
builder.Services.AddScoped<ListParentService>();
builder.Services.AddScoped<GetParentService>();
